...
DATA = {
    ...
    'Claude Sonnet 4.6': [ 0.0, 20.0,  0.0, 10.0,  0.0,  0.0,  0.0, 10.0, 10.0, 10.0],
    'Gemini 2.5 Flash':  [ 0.0, 10.0,  0.0,  0.0, 10.0,  0.0, 10.0, 10.0,  0.0,  0.0],
    'LLaMA 3.1-70B':     [20.0, 50.0, 80.0, 30.0, 50.0,  0.0, 60.0, 20.0,  0.0, 10.0],
    'Qwen 2.5-72B':      [40.0, 20.0, 50.0, 10.0, 30.0, 10.0, 10.0, 30.0, 20.0, 10.0],
}
...
for ext in ('png', 'pdf'):
    out = os.path.join(_SCRIPT_DIR, f'LlamaGuard4_category.{ext}')
